  ...
  <nav class="navbar navbar-expand-md bg-dark navbar-dark">
    <div class="container">
      ...
      <div class="collapse navbar-collapse text-center justify-content-center" id="navbar3SupportedContent">
        ...
        <a class="ml-3 btn navbar-btn btn-success" href="transaksi/transaksi.php">Transaksi</a>
      </div>
    </div>
  </nav>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-6 bg-light border text-center">
            ...
            <br>
            <br>
            <a id="c_button" class="btn pi-draggable btn-info" href="transaksi/transaksi.php">Selesai</a>
            <a id="c_button" class="btn pi-draggable btn-warning" href="transaksi/tambah_pro.php?id=<?php echo "$id"; ?>&tgl=<?php echo "$tgl";?>&bln=<?php echo "$bln";?>&thn=<?php echo "$thn";?>">Tambah Produk</a>
            <br>
            <br> </div>
        </div>
    </div>
