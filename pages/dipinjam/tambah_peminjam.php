    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-6 bg-secondary">
          ...
          <form action="../../includes/dipinjam/tambah.php" method="POST">
            <div class="form-group"> <label for="InputName">Nama</label>
              <input type="text" class="form-control" name="nama" placeholder="Nama peminjam" required> </div>
            <div class="form-group"> <label for="InputName">Nomer Distributor</label>
              <input type="text" class="form-control" name="nodis" placeholder="Nomer distributor"> </div>
             ...
             <div class="form-group"> <label for="InputName">Kode Produk</label>
              <input type="number" class="form-control" name="kod" id="InputName" placeholder="Kode produk"> </div>
            <div class="form-group"> <label for="InputName">Jumlah</label>
              ...
              <input type="hidden" value="<?php echo "$id"; ?>" class="form-control" name="id" id="InputName" placeholder="Jumlah produk yang dipinjam"> </div>
